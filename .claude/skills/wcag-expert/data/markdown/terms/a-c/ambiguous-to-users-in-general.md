...
term: ambiguous to users in general
---
...
the purpose cannot be determined from the link and all information of the web page
   ...
   ExampleThe word guava in the following sentence "One of the notable exports is guava" is
...
📖 **Reference**: [WCAG 2.2 Glossary - ambiguous to users in general](https://www.w3.org/TR/WCAG22/#dfn-ambiguous-to-users-in-general)
